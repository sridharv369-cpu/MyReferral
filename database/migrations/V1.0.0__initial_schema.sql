...
PROJECT: MyReferral
VERSION: 1.0.0
DESCRIPTION: Initial schema migration - ENUM types, public.users, and referral_posts
================================================================================
...
PURPOSE:
  ...
  synchronized from Supabase auth.users, and the referral_posts table containing
  job referral opportunities posted by employees.
...
/*
  ...
  OBJECTS CREATED:
    ...
    - 2 tables (public.users, public.referral_posts)
  ...
  NEXT STEPS: 
    ...
    - Run V1.2.0 migration to create comments, likes, and notifications tables
    - Apply database triggers for audit logging and search vector updates
