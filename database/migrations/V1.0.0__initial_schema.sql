...
PROJECT: MyReferral
VERSION: 1.0.0
DESCRIPTION: Initial schema migration - ENUM types, public.users, referral_posts, and comments
================================================================================
...
PURPOSE:
  ...
  job referral opportunities posted by employees, and the comments table for
  discussion on referral posts.
...
/*
  ...
  OBJECTS CREATED:
    ...
    - 3 tables (public.users, public.referral_posts, public.comments)
  ...
  NEXT STEPS: 
    ...
    - Run V1.2.0 migration to create likes and notifications tables
